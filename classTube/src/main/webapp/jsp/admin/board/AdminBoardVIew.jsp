...
<body>
	...
	<div class="container">
			...
			<c:forEach var="comment" items="${commentList}">
				<div class="comment">
					...
					<span class="comment-date"><fmt:formatDate
							value="${comment.createAt}" pattern="yyyy-MM-dd HH:mm:ss" /></span>
					<!-- 댓글 작성일 -->
				</div>
			</c:forEach>
			<form
				action="${pageContext.request.contextPath}/admin//BoardCommentAdd"
				method="post">
		...
		<script
			src="${pageContext.request.contextPath}/js/admin/adminBoardView.js"></script>
</body>
</html>